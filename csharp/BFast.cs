...
namespace Vim
{
    ...
    public static class BFast
    {
        ...
        /// </summary>
        public static byte[] CopyTo(this BFastData data, byte[] dest, int offset = 0)
        {
            ...
            // TODO: heuristics so that small data is not parallelized 
            Parallel.For(0, data.Ranges.Length,
                i =>
                {
